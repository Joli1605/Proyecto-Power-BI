...
El objetivo de este proyecto fue crear un dashboard interactivo y dinámico que permite visualizar y analizar datos de ventas, costos y rentabilidad.Se describen las características del proyecto, incluyendo las transformaciones aplicadas a cada tabla y las visualizaciones creadas.
