...
En este proyecto se visualiza un dashboard interactivo y dinámico que facilita la visualización y el análisis de datos sobre ventas, costos y rentabilidad.
